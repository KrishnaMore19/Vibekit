  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative" style={{ background: 'var(--bg)' }}>
      ...
      <motion.div
        ...
        <p className="text-sm mb-8" style={{ color: 'var(--text-2)' }}>Sign in to your VibeKit Studio</p>
        ...
        <div className="mt-5 pt-5" style={{ borderTop: '1px solid var(--border)' }}>
          <p className="text-center text-sm" style={{ color: 'var(--text-3)' }}>
            No account yet?{' '}
            <Link to="/signup" className="font-semibold transition-colors" style={{ color: 'var(--amber)' }}>
              Create one free →
            </Link>
          </p>
        </div>
